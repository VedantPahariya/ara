...
rm -f ${ARA_ROOT}/install/riscv-llvm/lib/clang/16/lib
mkdir -p ${ARA_ROOT}/install/riscv-llvm/lib/clang/16/lib/riscv64-unknown-unknown-elf

# Copy the runtime library to the expected location
cp ${ARA_ROOT}/install/riscv-llvm/lib/linux/libclang_rt.builtins-riscv64.a \
   ${ARA_ROOT}/install/riscv-llvm/lib/clang/16/lib/riscv64-unknown-unknown-elf/libclang_rt.builtins.a
```
...
```
bash: line 1: /ssd_scratch/ara/install/riscv-gcc/bin/riscv64-unknown-elf-gcc: No such file or directory
...
chmod +x /ssd_scratch/ara/scripts/riscv_tests_llvm.sh
